...
class TagsManager {
    ...
    updateStatisticsCards() {
        if (!this.tagsData || !this.statisticsData) return;

        document.getElementById('totalCategories').textContent = this.statisticsData.totalCategories || 0;
        document.getElementById('totalCommonTags').textContent = this.statisticsData.totalCommonTags || 0;
        document.getElementById('totalActiveTags').textContent = this.statisticsData.tagUsage?.length || 0;
        document.getElementById('totalUnusedTags').textContent = this.statisticsData.unusedCommonTags?.length || 0;
    }
