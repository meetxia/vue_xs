...
// 暂时注释掉安全限制器，因为缺少依赖
// const { apiLimiter, uploadLimiter, fieldValidators, asyncErrorHandler } = require('../middleware');
...
// 获取所有标签
router.get('/tags', asyncErrorHandler(async (req, res) => {
